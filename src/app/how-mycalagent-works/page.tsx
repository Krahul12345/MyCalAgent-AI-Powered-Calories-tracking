...
export default function HowMyCalAgentWorksPage() {
  return <><PageSchema path="/how-mycalagent-works" title="How MyCalAgent Works" description={description} faq={faq} /><EditorialPage>
    <EditorialHero label="HOW IT WORKS" title={"How MyCalAgent\nworks."} description="Capture a meal. Review the details. Bring a little more context to your everyday routines." image="/how-it-works-editorial.png" alt="Illustrative photograph of a phone capturing a colorful lunch on a light table" href="#walkthrough" action="Follow a meal" />
